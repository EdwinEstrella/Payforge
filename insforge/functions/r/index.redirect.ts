export default async function (req: Request): Promise<Response> {
  ...
  const baseUrl = Deno.env.get('INSFORGE_INTERNAL_URL') || Deno.env.get('INSFORGE_BASE_URL') || Deno.env.get('INSFORGE_URL')
  ...
  try {
    ...
    return new Response('Short link lookup timed out', { status: 504, headers: corsHeaders })
  } finally {
